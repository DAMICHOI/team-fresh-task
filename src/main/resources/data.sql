...
INSERT INTO VOC (type, contents, status, customer_id, carrier_id, created_at)
VALUES ('CARRIER', '다른 배송지로 운송되어 클레임 인입', 'PROCEED', 3, 1, CURRENT_TIMESTAMP)
     , ('CUSTOMER', '고객사의 물건 누락으로 배송 실수', 'END', 1, 2, CURRENT_TIMESTAMP);